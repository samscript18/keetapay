...
export function ActivityList({ transactions, currentUsername, emptyMessage = "No transactions yet. Send the first one." }: { transactions: ApiTransaction[]; currentUsername?: string; emptyMessage?: string }) {
