      ...
      <main className="grid min-h-screen place-items-center bg-background px-4 text-foreground">
        <div className="max-w-md rounded-[8px] border border-white/10 bg-white/[0.06] p-6">
          ...
          <p className="mt-3 text-sm leading-6 text-white/58">
            Add `NEXT_PUBLIC_PRIVY_APP_ID` to `frontend/.env.local`, then restart the frontend dev server.
            Privy is used only for login and sessions; Keeta Pay does not create embedded Privy wallets.
          </p>
        </div>
      </main>
    );
